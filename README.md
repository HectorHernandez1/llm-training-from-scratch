...
## License and credits
MIT — see [LICENSE](LICENSE). The notes and code-alongs are my own work, but the
curriculum they follow is **Andrej Karpathy's
[Neural Networks: Zero to Hero](https://karpathy.ai/zero-to-hero.html)**, and the
